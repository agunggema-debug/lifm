        ...
        {tab === "home" && (
          <div className="grid gap-3">
            <div className="anim-pop rounded-3xl p-5 shadow-2xl text-white" style={{ background: "linear-gradient(180deg, #020617, #0f172a)", border: "1px solid rgba(255,255,255,.12)" }}>
              <div className="text-[11px] uppercase tracking-widest opacity-60 text-center">Next Match • Pekan {next ? next.matchday : "-"}{next && next.fixture && aclCompName(next.fixture.competition) ? (aclStage(next.matchday, save.acl_tier) ? ' • ' + aclCompName(next.fixture.competition) + ' ' + aclStage(next.matchday, save.acl_tier) : ' • ' + aclCompName(next.fixture.competition) + ' MD ' + aclRound(next.matchday, save.acl_tier)) : ' • Indonesia Super League ' + seasonLabel(save.season)}</div>
              {next && !next.finished ? (
