        ...
        {tab === "home" && (
          <div className="grid gap-3">
            <div className="anim-pop rounded-3xl p-5 shadow-2xl text-white" style={{ background: "linear-gradient(180deg, #020617, #0f172a)", border: "1px solid rgba(255,255,255,.12)" }}>
              <div className="text-[11px] uppercase tracking-widest opacity-60 text-center">Next Match • Pekan {next ? next.matchday : "-"}{next && next.fixture && next.fixture.competition === 'acl_two' ? (next.matchday >= 18 ? ' • ACL ' + aclStage(next.matchday) : ' • ACL TWO Fase Grup') : ' • BRI Super League 2026/27'}</div>
              {next && !next.finished ? (
